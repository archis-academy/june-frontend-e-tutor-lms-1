            ...
            <div className={styles.footersectionbox} >
                <div className={styles.footersectionboxleft}>
                    ...
                    <div className={styles.footersectionsocial}>
                        <a href="https://www.facebook.com/"><Image src={Facebook} width={20} height={20} alt="logo" /></a>
                        <a href="https://twitter.com/"><Image src={Twitter} width={20} height={20} alt="logo" /></a>
                        <a href="https://www.linkledin.com/"><Image src={Linkledin} width={20} height={20} alt="logo" /></a>
                        <a href="https://www.youtube.com/"><Image src={Youtube} width={20} height={20} alt="logo" /></a>
                    </div>
                </div>
